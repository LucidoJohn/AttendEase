<?php
  ...
  $display_all = "SELECT * FROM entity_information where type_id = 2";
...
<div>
    <form action="studentRecords.php" method="POST">
  ...
  <tbody>
    <tr>
      ...
      <td class="px-5">
        ...
        <a href="promote.php?id=<?php echo $rows['id']; ?>" class="badge badge-info"> Promote </a>
        <a href="edit.php?id=<?php echo $rows['id']; ?>" class="badge badge-warning"> Edit </a>
