<?php
    ...
    $count_all_present = "SELECT COUNT(*) from date_status where student_status = 'Present' and id = '$user'";
    $count_all_late = "SELECT COUNT(*) from date_status where student_status = 'Late' and id = '$user'";
